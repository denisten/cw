...
export class BuildingsDescriptionService {
  readonly _description: BuildingsDescriptionType = {
    ...
    [TowersTypes.OBSERVATORY]: [
      'Твой дом - твоя крепость! Домашний кинотеатр, киберспортивный турнир, работа  - а можно из дома? Конечно!',
    ...
    [TowersTypes.ARENA]: [
      'Чем заняться на выходных? Заезжай на МТС Арену. Уже скоро лучше события на одной площадке.',
