...
export class BuildingsDescriptionService {
  readonly _description: BuildingsDescriptionType = {
    [TowersTypes.POISK]: [
      'Не задавайся вопросом, где твой близкий человек. С ним все хорошо, потому что с тобой МТС Поиск!',
      'Заблудился или разминулся с друзьями? Хочешь знать, где сейчас находится твой ребенок? Сотрудники нуждаются в дополнительном контроле?',
      'Для решения этих задач тебе достаточно обычного мобильного телефона. С МТС Поиск найти друзей, родных или нужное место в городе не составит большого труда!',
      'МТС Поиск основан на определении текущего местоположения абонента с использованием информации от ближайших базовых станций. За счет этого услуги доступны практически для любой модели телефона, вне зависимости от производителя и наличия дополнительных опций.',
      'А еще мы знаем, как сложен вопрос «Ты где?». Редкий ребёнок готов с энтузиазмом, прилежанием, а главное — точностью поддерживать диалог, начатый с этой фразы. Вместе с тем легко и быстро получить нужный ответ поможет МТС Поиск.',
    ],
    [TowersTypes.GOODOK]: [
      'Порадуй друзей и знакомых смешными приколами, новинками или любимыми хитами! Поделись своим настроением с другими!',
      `Подключай услугу "GOOD'OK" и пусть хорошее настроение станет залогом приятного общения.`,
      'Широкий каталог мелодий, возможность настраивать проигрывание мелодии: по расписанию, для разных людей разные мелодии гудка. И еще загружать персональные гудки!',
    ],
    [TowersTypes.MAIN_TOWER]: [
      'Семья, друзья, любимые – вас всегда связывает что-то большее. Укрепляйте связь.',
      'Мобильная связь от МТС - это гарантия надежности! Ты найдешь любые пакеты минут, которые покрывают твои потребности! Звони, как по России, так и по миру, подбирай тарифы с минутами под себя!',
    ],
    [TowersTypes.WASD_TV]: [
    ...
    [TowersTypes.ROAMING]: [
      ...
      'Роуминг за границей — это про комфорт! У нас есть тарифы, которые подойдут каждому, есть из чего выбрать! Мы не боимся роуминга, и ты не бойся!',
      'Будь на связи в любой точке мира, делись впечатлениями, будь собой — с нами можно все!',
    ],
    [TowersTypes.FITNESS]: [
      'В здоровом теле здоровый дух! Будь в форме каждый день и ощущай жизненную энергию.',
      'Удобный помощник по здоровому образу жизни! Он поможет с персональными планами питания и программой от тренера.',
    ...
    [TowersTypes.THEATER]: [
      ...
      'МТС Live - комфортный и надежный в использовании сервис с билетами без комиссии.',
    ...
    [TowersTypes.LIBRARY]: [
      'Знания – сила и удивительный мир в одном. Обогащайся и становись лучше каждый день! Прокачай свой потенциал до максимума.',
      ...
      '∙ 270 тысяч книг новинок и бестселлеров всех жанров;',
      '∙ 40 тысяч аудиокниг.',
    ...
    [TowersTypes.MUSIC]: [
      ...
      'В МТС Music мы собрали миллионы музыкальных треков. Сейчас в каталоге больше 50 миллионов композиций: чтобы прослушать всё, не хватит и ста лет. Любой желающий, даже не будучи абонентом МТС, может воспользоваться сервисом! Слушай музыку онлайн, добавляй любимые треки в плейлисты и наслаждайся ими офлайн на своем гаджете.',
    ...
    [TowersTypes.SPUTNIK]: [
      'Одна красная тарелка в которой уместятся твои интересы, вкусы и хобби. Даже те, о которых ты еще не знаешь!',
    ...
    [TowersTypes.HOME_INTERNET]: [
      ...
      'А еще домашний кинотеатр, киберспортивный турнир, работа — теперь все доступно из дома.',
    ...
    [TowersTypes.SMARTMED]: [
      'Заботься о здоровье. Пусть на любой план хватает сил и времени.',
      'SmartMed - настоящий прорыв в современной медицине!',
      'SmartMed - это сервис для онлайн-консультаций с квалифицированными врачами в удобное для тебя время по видео, телефону или в чате.',
      'Ты сможешь:',
      '∙ консультироваться онлайн из любой точки мира с практикующими врачами клиник МЕДСИ – не только с терапевтами и педиатрами, но и с профильными специалистами;',
      '∙ записываться на прием в клинике;',
      '∙ вызывать врача на дом для себя и ребенка;',
      '∙ хранить историю телемедицинских консультаций;',
      '∙ оперативно узнавать подробную информацию о врачах и клиниках.',
    ],
  };
